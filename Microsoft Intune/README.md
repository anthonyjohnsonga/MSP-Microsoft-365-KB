...
### [Browser Extension Runbooks](./Browser%20Extensions/README.md)

Settings Catalog policy guides for deploying, configuring, validating, and removing managed browser extensions.
